...
final readonly class EventStoreDebuggingInternalsFactory implements ContentRepositoryServiceFactoryInterface
{
    ...
    {
        return new EventStoreDebuggingInternals($serviceFactoryDependencies->eventStore, $serviceFactoryDependencies->subscriptionEngine, $serviceFactoryDependencies->eventNormalizer);
    }
}
